...
function OnboardingLeft() {
  return (
    <div
        className="flex items-center justify-center w-2/5 p-8 min-h-screen bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: "url(/images/bg-onboarding.jpg)" }}
      >
        <div className="relative w-[450px] h-[450px] rounded-full bg-[#2d4a2b] shadow-lg flex items-center justify-center text-center p-4">
