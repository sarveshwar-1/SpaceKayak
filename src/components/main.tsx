...
const Main = () => {
  return (
      <div className=" mx-auto px-4 py-12 bg-[#eeede5] w-full ">
        <div className="grid grid-cols-7 gap-8 h-full">
          ...
          <div className="col-span-5 h-full overflow-x-auto">
            <div className="flex gap-6 h-full">
              {/* Any Occasion Card */}
              <div className="bg-white shadow-md overflow-hidden h-full flex-shrink-0 w-80">
              <div className="flex flex-col ">
                <div className="bg-gray-200 h-[38vh] bg-cover bg-center" 
                     style={{backgroundImage: "url('images/image-1.jpg')"}}>
                </div>
                <div className="p-6">
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Any Occasion</h3>
                  <hr />
            ...
            {/* Gen Z Cookbook Card */}
            <div className="bg-white shadow-md overflow-hidden flex-shrink-0 w-80">
              <div className="flex flex-col">
                <div className="bg-yellow-100 h-[38vh] bg-cover bg-center"
                     style={{backgroundImage: "url('images/image-2.jpg')"}}>
                </div>
                <div className="p-6">
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Gen Z Cookbook</h3>
                  <hr />
            ...
            <div className="bg-white shadow-md overflow-hidden flex-shrink-0 w-80">
              <div className="flex flex-col">
                ...
                <div className="p-6">
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Chris De La Rosa</h3>
                  <hr />
                  <p className="text-gray-600 mb-4">Caribbean cooking made self-taught chef</p>
                  <ArrowButton className='inline-flex items-center px-4 py-2 border border-gray-600  hover:bg-gray-50' text='MORE' textcolor='text-gray-900'/>
                </div>
